...
# Define a new gene sequence to test
new_sequence = "AGCTTGACCTGA"  # Example sequence, replace with actual sequence

# Predict the class for the new sequence
prediction = classifier.predict([new_sequence])
print(f"Predicted class for the sequence: {prediction[0]}")


print("\nExample prediction:")
test_sequence = X_test.iloc[0]
true_class = y_test.iloc[0]
predicted_class = classifier.predict([test_sequence])[0]
